...
public class Clienttaskinprogress extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clienttaskinprogress);
    ...
    public void  done(View view) {
        ...
        if (phonecheck.isEmpty()) {
            Toast.makeText(Clienttaskinprogress.this, "No task is in progress", Toast.LENGTH_SHORT).show();
        } else {
            Intent getphone = getIntent();
            String phone1 = getphone.getStringExtra("email");
            reff = FirebaseDatabase.getInstance().getReference("user").child(phone1);
